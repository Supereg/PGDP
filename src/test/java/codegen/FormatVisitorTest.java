...
public class FormatVisitorTest {
    ...
    public void testFak() {
        Program program = new Program(
                ...
                new Function("main", new String[0], new Declaration[0], new Statement[] {
                        new ExpressionStatement(new Write(new Call("fak", new Read()))),
                        new Return(new Number(0))
                }));
    ...
    public void testGGT() {
        Program program = new Program(new Function("ggt", new String[] {"a", "b"}, new Declaration[] {new Declaration("temp")}, new Statement[] {
                ...
                new Function("main", new String[0], new Declaration[0], new Statement[] {
                        new ExpressionStatement(new Write(new Call("ggt", new Read(), new Read()))),
                        new Return(new Number(0))
                }));
    ...
    public void formatTest() {
        Program program = new Program(new Function("main", new String[0], new Declaration[0], new Statement[] {
                new Return(new Call("test", new Number(1), new Number(2)))}),
    ...
    public void testThreads() {
        ...
        Function main = new Function(Type.Int, "main", new Parameter[0], new Declaration[] {
                ...
                new ExpressionStatement(new ArrayLength(new Variable("array"))),
        ...
        assertEquals("Unexpected code format", "int inc(int[] array) {\n" +
                "  synchronized (array) {\n" +
                "    array[0] = (array[0] + 1);\n" +
                "  }\n" +
                "  return 42;\n" +
