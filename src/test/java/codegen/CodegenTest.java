...
public class CodegenTest {
            ...
            Program program = new Program(
                    new Function("fak", new String[] {"n"}, new Declaration[0], new Statement[] {
                            ...
                            new Return(new Binary(new Variable("n"), Binop.MultiplicationOperator,
                                    new Call("fak", new Binary(new Variable("n"), Binop.Minus, new Number(1)))))
                    }),
                    new Function("main", new String[0], new Declaration[0], new Statement[] {
                            new Return(new Call("fak", new Number(i)))
                    }));
    ...
    public void testGreaterThan() {
        Program program = new Program(new Function("main", new String[0], new Declaration[] {new Declaration("a", "b", "result")}, new Statement[] {
    ...
    @Test
    public void testGGT() {
        Program program = new Program(new Function("ggt", new String[] {"a", "b"}, new Declaration[] {new Declaration("temp")}, new Statement[] {
                ...
                new Function("main", new String[0], new Declaration[0], new Statement[] {
                        new Return(new Call("ggt", new Number(54), new Number(24)))
                }));
    ...
    public void testSum() {
        Function main = new Function("main",
                ...
                new Declaration[] {},
                new Statement[] {
                        new Return(new Call("sum", new Number(10), new Number(15)))
                });
        ...
        Program program = new Program(sum, main);
    ...
    public void testCustomExample0() {
        Program program = new Program(new Function("main", new String[0], new Declaration[0], new Statement[] {
                new Return(new Call("test", new Number(15), new Number(8)))}),
                new Function("test", new String[] {"a", "b"}, new Declaration[] {
                        new Declaration("biggest", "result")
                }, new Statement[] {
    ...
    public void testDoublyNamedDeclaration() {
        Program program = new Program(
                ...
                new Function("asd", new String[] {"ralf", "olaf"}, new Declaration[] {
                        new Declaration("fred", "heinz"),
                        new Declaration("fred")
                }, new Statement[] {
                        new Return(new Number(0))
                }));
    ...
    public void testNotInitializedVariable() {
        Program program = new Program(new Function("main", new String[0], new Declaration[] {
                new Declaration("test")
        }, new Statement[] {
    ...
    public void testVariableNotFound() {
        Program program = new Program(new Function("main", new String[0], new Declaration[0], new Statement[] {
                new Return(new Call("sum", new Number(3), new Number(2)))}),
    ...
    public void testBadArgumentNumber() {
        Program program = new Program(new Function("main", new String[0], new Declaration[0], new Statement[] {
                new Return(new Call("sum", new Number(3), new Number(2), new Number(5)))}),
                new Function("sum", new String[] {"a", "b"}, new Declaration[0], new Statement[] {
