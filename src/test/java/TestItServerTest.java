...
//
      ...
      assertEquals("C.txt: gar nicht.", in.readLine().trim());
      assertEquals("D.txt: 1x", in.readLine().trim());
      assertEquals("E.txt: 1x", in.readLine().trim());
      assertEquals("B.txt: gar nicht.", in.readLine().trim());
      assertEquals("A.txt: gar nicht.", in.readLine().trim());
      skipNewline(in);
      testPrompt(in);

      out.println("pageRank");
      assertEquals("C.txt; PageRank: 0.19999999999999987", in.readLine().trim()); // turned 0.2 into 0.19999999999999987
      assertEquals("D.txt; PageRank: 0.19999999999999987", in.readLine().trim());
      assertEquals("E.txt; PageRank: 0.19999999999999987", in.readLine().trim());
      assertEquals("B.txt; PageRank: 0.19999999999999987", in.readLine().trim());
      assertEquals("A.txt; PageRank: 0.19999999999999987", in.readLine().trim());
      skipNewline(in);
      testPrompt(in);
